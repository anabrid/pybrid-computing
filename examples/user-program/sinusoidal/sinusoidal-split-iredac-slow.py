...
class UserProgram(SimpleRun):
    ...
    RUN_CONFIG = RunConfig(op_time=100_000_000)
    DAQ_CONFIG = DAQConfig(sample_rate=1_000)
    ...
    def set_configuration(self, run: Run, computer: REDAC):
        ...
        for idx, carrier in enumerate(computer.carriers):
            ...
            cluster_b.m0block.elements[0].k = 100
        ...
        i0_m0_cl0.m0block.elements[4].ic = -0.6
        i0_m0_cl0.m0block.elements[4].k = 100
        i0_m0_cl0.ublock.connect(4, 24)
        i0_m0_cl0.cblock.elements[24].factor = -1.0
        i0_m0.tblock.muxes[64] = 1
        i0_m0.st0block.muxes[64] = 1
        i1_m0.st0block.muxes[65] = 0
        i1_m0.tblock.muxes[65] = 0
        i1_m0_cl0.iblock.connect(24, 4)

        # Second integrator from iREDAC1 to iREDAC0
        i1_m0_cl0.m0block.elements[4].ic = 0
        i1_m0_cl0.m0block.elements[4].k = 100
