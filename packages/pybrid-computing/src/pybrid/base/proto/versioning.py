...
class ProtoVersioning:
    ...
    update_path = {
        pb.File: [(pb.Version(major=0, minor=1, patch=0), FileUpdate_0_1_0_to_0_2_0)],
        pb.Envelope: [(pb.Version(major=0, minor=1, patch=0), EnvelopeUpdate_0_1_0_to_0_2_0)],
    }
    ...
    def current(cls):
        ...
        return pb.Version(major=0, minor=1, patch=0)
    ...
    def is_same(cls, lhs: pb.Version, rhs: pb.Version):
        ...
        return not cls.is_newer(lhs, rhs) and not cls.is_newer(rhs, lhs)
    ...
    def is_recent(cls, input: pb.File | pb.Envelope):
        ...
        return not cls.is_newer(input.version, cls.current()) and not cls.is_newer(cls.current(), input.version)
