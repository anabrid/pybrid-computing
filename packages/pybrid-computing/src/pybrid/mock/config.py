...
class DummyDACConfig:
    ...
    #: When True, introduce an asyncio.sleep(op_time_seconds) delay during OP phase
    #: to simulate the real device's analogue computation time.  Default False keeps
    #: existing DummyDAC behaviour (runs complete instantly).
    simulate_op_time: bool = False
