...
class DescribeHandler(BaseHandler):
    ...
    async def handle(
        self, cmd: pb.DescribeCommand, protocol: "Protocol"
    ) -> pb.DescribeResponse:
        """
        Handle a describe command by returning the entity tree.

        :param cmd: The describe command (unused but required by protocol).
        :param protocol: The protocol instance (unused but required by callback signature).
