...
class File(_message.Message):
    __slots__ = ("version", "bundle", "entity")
    VERSION_FIELD_NUMBER: _ClassVar[int]
    BUNDLE_FIELD_NUMBER: _ClassVar[int]
    ENTITY_FIELD_NUMBER: _ClassVar[int]
    version: Version
    bundle: ConfigBundle
    entity: Entity
    def __init__(self, version: _Optional[_Union[Version, _Mapping]] = ..., bundle: _Optional[_Union[ConfigBundle, _Mapping]] = ..., entity: _Optional[_Union[Entity, _Mapping]] = ...) -> None: ...
