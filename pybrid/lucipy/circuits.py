...
class Circuit:
    ...
    def __init__(self):
        ...
        self._lucidac = Helpers.create_minimal_lucidac()
    ...
    def to_config(self, use_virtual_macs=True):
        """
        ...
        :param use_virtual_macs: Currently unused; virtual MACs are always used
            because the internal LUCIDAC is created with the default virtual MAC.
    ...
    def generate(self, skip=None, sanity_check=True):
        ...
        return {"00-00-00-00-00-00": carrier_config}
