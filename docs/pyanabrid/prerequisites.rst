...
the main focus of course lies on doing hybrid computing with analog computers, thus
**having an analog computer is strongly recommended**.



Supported Analog Computers
--------------------------

:doc:`/redac/index`
    The REDAC Analog Computer from `anabrid`_.
